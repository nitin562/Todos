      ...
      <div className="Creation scrollbar">
        <div className="wrap">
          ...
          <div className="titleHandle">
            ...
            <input type="text" id="title" placeholder="Enter Title of Todo" onChange={HandleChange} value={TextObj.title} />
        ...
        <div className="btnPanel">
          ...
          <button id="Update" disabled={!globalstate.state.notes[Clicked]||Clicked===-1 } onClick={Update}>Update</button>
      ...
      <div className="collection">
       ...
       { globalstate.state.login&&<div className="AllNotes scrollbar">
        ...
        {globalstate.state.login&&<div className="CountNotes">
          <p>{operation}</p>
          <p>Todos:  <span>{globalstate.state.notes.length}</span></p>
        </div>}
      </div>
    </div>
  );
